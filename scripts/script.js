...
data: {
    visuals:[
        { id: 1,  name: 'Graphic Design', description: 'Personal Infographic CV'},
        { id: 2,  name: '3D ArchViz', description: 'Interior Visualization'},
        { id: 3,  name: '3D ArchViz', description: 'Exterior Visualization'},
        { id: 4,  name: '3D ArchViz', description: 'Aerial Visualization'},
        { id: 5,  name: '3D ArchViz', description: 'Exterior Visualization'},
        { id: 6,  name: '3D ArchViz', description: "Bird's Eye Visualization"},
        { id: 7,  name: '3D General', description: 'Realistic Vehicle Visualization (Original Version)'},
        { id: 8,  name: '3D General', description: 'Realistic Vehicle Visualization (Maps Version)'},
        { id: 9,  name: '3D General', description: 'Realistic Vehicle Visualization (Post-production Version)'},
        { id: 10, name: '3D ArchViz', description: 'Interior Visualization'},
        { id: 11, name: '3D ArchViz', description: 'Interior Visualization'},
        { id: 12, name: '3D ArchViz', description: 'Interior Visualization'},
        { id: 13, name: '3D ArchViz', description: 'Interior Visualization'},
        { id: 14, name: '3D ArchViz', description: 'Interior Visualization'},
        { id: 15, name: '3D ArchViz', description: 'Interior Visualization'},
        { id: 16, name: '3D General', description: 'Realistic Vehicle Visualization (Turntable Version)'},
        { id: 17, name: 'Game Design', description: 'CryEngine Level Design'},
        { id: 18, name: '3D General', description: 'Realistic Vehicle Visualization (On site Version)'},
        { id: 19, name: '3D ArchViz', description: 'Aerial Visualization'},
        { id: 20, name: '3D ArchViz', description: "Bird's Eye Visualization"},
        { id: 21, name: '3D ArchViz', description: "Bird's Eye Visualization"},
        { id: 22, name: '3D ArchViz', description: 'Exterior Visualization'},
        { id: 23, name: '3D ArchViz', description: 'Exterior Visualization'},
        { id: 24, name: '3D ArchViz', description: 'Exterior Visualization'},
        { id: 25, name: '3D ArchViz', description: 'Urban Design Visualization'},
        { id: 26, name: '3D ArchViz', description: 'Aerial Visualization'},
        { id: 27, name: '3D ArchViz', description: "Bird's Eye Visualization"},
        { id: 28, name: 'Game Development', description: 'Full Graphic & Game Design'},
        { id: 29, name: 'Game Development', description: 'Full Graphic & Game Design'},
        { id: 30, name: 'Game Development', description: 'Full Graphic & Game Design'},
        { id: 31, name: '3D ArchViz', description: 'Exterior Visualization'},
        { id: 32, name: '3D ArchViz', description: 'Exterior Visualization'},
        { id: 33, name: '3D ArchViz', description: 'Exterior Visualization'},
        { id: 34, name: '3D ArchViz', description: 'Exterior Visualization'},
        { id: 35, name: '3D ArchViz', description: 'Interior Visualization'},
        { id: 36, name: '3D ArchViz', description: 'Interior Visualization'},
        { id: 37, name: '3D ArchViz', description: 'Interior Visualization'},
        { id: 38, name: '3D ArchViz', description: 'Interior Visualization'},
        { id: 39, name: '3D ArchViz', description: 'Interior Visualization'},
        { id: 40, name: '3D Modelling', description: 'Character Modelling'},
        { id: 41, name: '3D Modelling', description: 'Character Modelling'},
        { id: 42, name: '3D Modelling', description: 'Character Modelling'},
        { id: 43, name: '3D Modelling', description: 'Environment Modelling'},
        { id: 44, name: '3D Modelling', description: 'Character Modelling'},
        { id: 45, name: '3D ArchViz', description: 'Interior Visualization'},
        { id: 46, name: 'Graphic Design', description: 'Corporate Identity'},
        { id: 47, name: 'Graphic Design', description: 'Corporate Identity'},
        { id: 48, name: 'Graphic Design', description: 'Corporate Identity'},
...
<div class="row justify-content-md-center">
    <div class="col-md col-lg-5 col-xl-4 p-0 m-0 ">
        <div class="row">
            ...
            <img class="edu-icon" :src="'img/'+logo+'.png'" alt="">
            </div>
